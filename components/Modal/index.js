...
export default function Modal({show, title, formControls = [], onAdd, formData, setFormData, setShow}) {
    return (
        <>
            {
                show ?
                                ...
                                <div className="relative p-5 flex-auto flex flex-col gap-5">
                                    {
                                        ...
                                        formControls.map((item)=> item.componentType === "input" ? (
                                        <Input type={item.type} placeholder={item.placeholder} label={item.label} />
